...
alias iggyp='IGGY_ENDPOINT=https://cloud.igneous.io ~/mesa/go/bin/linux_amd64/iggy'
alias iggyd='IGGY_ENDPOINT=https://dev.iggy.bz ~/mesa/go/bin/linux_amd64/iggy'
alias iggys='IGGY_ENDPOINT=https://staging.iggy.bz ~/mesa/go/bin/linux_amd64/iggy'
